...
#include "cachelib/allocator/datastruct/FLEXList.h"
...
namespace facebook::cachelib
{
        ...
        public:
            ...
            Container(Config c, PtrCompressor compressor)
                : // : compressor_(std::move(compressor)),
                  flexlist_(std::move(compressor)),
                  config_(std::move(c))
            {
            }
            Container(serialization::MMFLEXObject object, PtrCompressor compressor);
            ...
            //
            serialization::MMFLEXObject saveState() const noexcept;
        ...
        const noexcept
    {
        ...
        *configObject.updateOnRead() = config_.updateOnRead;
        ...
        serialization::MMFLEXObject object;
        *object.config() = configObject;
        *object.flexlist() = flexlist_.saveState();
        return object;
    }
    ...
    MMContainerStat MMFLEX::Container<T, HookPtr>::getStats() const noexcept
    {
        auto stat = Mutex_->lock_combine([this]()
            ...
            // to return them
            return folly::make_array(flexlist_.size()); });
